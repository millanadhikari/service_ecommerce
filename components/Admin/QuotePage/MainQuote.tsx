...
function MainQuote({ isOpen, onClose, id }) {
  return (
    <Box m={10}>
      <Modal
        isOpen={isOpen}
          ...
          <Box borderBottom="1px solid gray" borderColor="gray.200" pb={4}>
            ...
            <Box borderBottom="1px solid gray" borderColor="gray.200" py={4}>
              ...
              <Flex my={4}>
                <Box>
                <Grid
                     templateColumns='repeat(2, 2fr)' gap={4} >
                  {data.map((item) => (
                    ...
                    <Flex
                      ...
                      my={2}
                    >
                      {/* <BiBed fontSize="large" /> */}
                      <Icon as={item.icon} fontSize="large" />
                      <Text
                        fontWeight="semibold"
                        fontSize="13px"
                        fontFamily="sans-serif"
            ...
            <Box borderBottom="1px solid gray" borderColor="gray.200" py={4}>
              ...
              <Flex color="green.400" mt={3} fontSize="18px" alignItems="center" gap={2}>
                <MdAttachMoney/>
                <Box>
                  <Text fontWeight="semibold" fontSize="14px">
                    240
                ...
                <Text fontSize="10px" color="gray.400">excl. GST</Text>
              </Flex>
            </Box>
          </ModalBody>

          <ModalFooter>
            <Button colorScheme="blue" mr={3} onClick={onClose} fontWeight="light" bg="purple.500" fontSize="14px">
              Close
            </Button>
          </ModalFooter>
        </ModalContent>
